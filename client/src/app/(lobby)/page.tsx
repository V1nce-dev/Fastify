...
const GlobalStyle = createGlobalStyle`
  body {
    background: linear-gradient(#FFDBB9,#ae86a9);
    height: 100vh;
    margin-left: 20rem;
    margin-right: 20rem;
    margin-top: 0;
...
const TitleAndDiceContainer = styled.div`
  display: flex;
  align-items: center;
`;
